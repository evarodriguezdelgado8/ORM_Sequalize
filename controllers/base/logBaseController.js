...
export const getAll = async (req, res) => {
    try {
        const items = await logService.getAll();
        res.json(items);
    } catch (error) {
...
export const getById = async (req, res) => {
    try {
        const item = await logService.getById(req.params.id);
...
export const create = async (req, res) => {
    try {
        const newItem = await logService.create(req.body);
...
export const update = async (req, res) => {
    try {
        const updatedItem = await logService.update(req.params.id, req.body);
...
export const remove = async (req, res) => {
    try {
        const deleted = await logService.remove(req.params.id);
