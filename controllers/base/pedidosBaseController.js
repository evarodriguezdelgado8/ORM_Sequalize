...
export const getAll = async (req, res) => {
    try {
        const items = await pedidosService.getAll();
        res.json(items);
    } catch (error) {
...
export const update = async (req, res) => {
    try {
        const updatedItem = await pedidosService.update(req.params.id, req.body);
...
export const remove = async (req, res) => {
    try {
        const deleted = await pedidosService.remove(req.params.id);
