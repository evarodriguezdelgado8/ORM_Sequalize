...
export const getAll = async (req, res) => {
    try {
        const items = await productosService.getAll();
        res.json(items);
    } catch (error) {
...
export const update = async (req, res) => {
    try {
        const updatedItem = await productosService.update(req.params.id, req.body);
...
export const remove = async (req, res) => {
    try {
        const deleted = await productosService.remove(req.params.id);
